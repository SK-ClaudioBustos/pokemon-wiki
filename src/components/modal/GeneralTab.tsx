...
export const GeneralTab = () => {
  const {
    pokemonData,
    loadingPokemonData: loading,
    errorPokemonData: error,
  } = useDataContext();
  ...
  return (
    <div>
      <div className="details-content">
        <div className="details-img">
          <button
            style={
              {
                "--shiny-color": showShiny ? "#fce024" : "#c1c1c1",
              } as React.CSSProperties
            }
            onClick={() => setShowShniy(!showShiny)}
          ...
          <img
            src={showShiny ? pokemonData.img.shiny : pokemonData.img.normal}
                ...
                style={
                  {
                    "--j":
                      pokemonTypes[
                        type.type.name.toLocaleLowerCase() as keyof typeof pokemonTypes
                      ][0],
                    "--k":
                      pokemonTypes[
                        type.type.name.toLocaleLowerCase() as keyof typeof pokemonTypes
      ...
      <p style={{ textAlign: "center", margin: "0 5px 10px" }}>
        You can switch to the shiny version by clicking on the star.
      </p>
    </div>
  );
};
